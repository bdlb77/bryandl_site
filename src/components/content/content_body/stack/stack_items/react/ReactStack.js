...
import './ReactStack.scss';
class ReactStack extends Component {
	componentDidMount() {
		const bar = new ProgressBar.Circle('#contain-react-stack', {
      color: '#FFEA82',
      trailColor: '#eee',
      trailWidth: 1,
      duration: 2600,
	...
	render() {
		return (
		    <div id="contain-react-stack" className="contain-react-stack">
   				<svg id="react-stack" viewBox="0 0 128 128">
